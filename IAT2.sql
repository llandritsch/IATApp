...
DROP TABLE IF EXISTS `segmentinfo`;
CREATE TABLE `segmentinfo` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `county` varchar(45) NOT NULL,
  `SegmentName` varchar(45) NOT NULL,
  `Distance` double NOT NULL,
  `ElevationGrade` int NOT NULL,
  `TechnicalGrade` int NOT NULL,
  `WaterAvailable` int NOT NULL,
...
(21,	'LucyGoosey',	'$2y$10$zooOHpYg1pjkPqV.oGYZSOeYXScidpQ9YhHD/icFxLnnvQFGjzWq6',	'Lucy',	'Andritsch',	'lucy@lucy.com'),
(22,	'beetjuice',	'$2y$10$CvpM172K5apHyt.a6LEqguFFQErRzbxvLLjtusCtbhPss4BhyDnPW',	'Beetle',	'Juice',	'juicy@beetles.com');
...
CREATE TABLE `usersegments` (
  ...
  `elevationGain` int DEFAULT NULL,
  `elevationLoss` int DEFAULT NULL,
  `comments` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`completedID`),
  KEY `segment` (`userID`,`segmentID`),
  KEY `segmentFK` (`segmentID`),
  CONSTRAINT `segmentFK` FOREIGN KEY (`segmentID`) REFERENCES `segmentinfo` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `userFK` FOREIGN KEY (`userID`) REFERENCES `userinfo` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(5,	20,	1,	'1988-09-12',	12,	45,	9.23,	123,	432,	'Your comments here'),
(6,	20,	143,	'2020-03-01',	8,	49,	8,	543,	564,	'Your comments here'),
(7,	20,	144,	'2020-10-31',	5,	56,	8,	123,	35,	'Your comments here'),
(8,	20,	145,	'2020-09-21',	5,	49,	8,	123,	564,	'Your comments here'),
(9,	20,	146,	'2020-10-31',	5,	56,	8,	342,	35,	'Your comments here'),
(10,	20,	148,	'2020-09-21',	11,	71,	8,	123,	564,	'Your comments here'),
(11,	20,	150,	'2020-03-01',	8,	79,	8,	54,	123,	'Your comments here'),
(12,	20,	58,	'2020-09-21',	11,	71,	8,	123,	35,	'Your comments here'),
(13,	20,	187,	'2020-10-31',	5,	49,	8,	123,	345,	'Your comments here'),
(14,	20,	138,	'2020-03-01',	3,	79,	8,	342,	4,	'Your comments here'),
(15,	20,	141,	'2020-10-21',	11,	90,	8,	54,	345,	'Your comments here'),
(16,	20,	167,	'2020-09-21',	11,	49,	8,	123,	4,	'Your comments here'),
(18,	20,	110,	'2020-11-30',	5,	71,	8,	123,	123,	'Test'),
(19,	20,	111,	'2020-11-29',	5,	79,	8,	543,	345,	'Test'),
(20,	20,	112,	'2020-11-29',	12,	56,	8,	543,	564,	'Your comments here'),
(21,	20,	113,	'2020-11-23',	12,	90,	10,	54,	123,	'Your comments here'),
(22,	20,	114,	'2020-11-20',	12,	49,	8,	54,	4,	'Your comments here'),
(23,	20,	117,	'2020-11-26',	12,	79,	10,	342,	123,	'Your comments here'),
(24,	20,	118,	'2020-11-28',	8,	56,	8,	54,	564,	'Your comments here'),
(25,	20,	119,	'2020-11-25',	11,	90,	8,	34,	564,	'Your comments here'),
(26,	20,	121,	'2020-11-27',	3,	71,	8,	543,	35,	'Your comments here'),
(27,	20,	122,	'2020-11-29',	5,	79,	8,	54,	35,	'Your comments here'),
(28,	20,	124,	'2020-11-20',	12,	56,	8,	123,	4,	'Your comments here'),
(29,	20,	125,	'2020-11-17',	3,	79,	8,	342,	564,	'Your comments here'),
(30,	20,	13,	'2020-11-23',	12,	27,	8,	543,	4,	'Your comments here'),
(31,	20,	14,	'2020-11-20',	11,	90,	10,	54,	123,	'Your comments here'),
(32,	20,	16,	'2020-11-29',	12,	56,	8,	342,	345,	'Your comments here'),
(33,	20,	18,	'2020-11-05',	8,	71,	8,	123,	123,	'Your comments here'),
(34,	20,	20,	'2020-11-17',	11,	79,	8,	543,	345,	'Your comments here'),
(35,	20,	33,	'2020-11-30',	5,	56,	8,	342,	345,	'Your comments here'),
(36,	20,	34,	'2020-11-29',	12,	49,	10,	123,	564,	'Your comments here'),
(37,	20,	109,	'2020-11-11',	11,	49,	10,	543,	345,	'Your comments here'),
(39,	20,	57,	'2020-11-25',	8,	49,	8,	54,	4,	'Your comments here'),
(40,	20,	137,	'2020-11-17',	3,	71,	10,	543,	564,	'Your comments here'),
(41,	20,	96,	'2020-11-19',	3,	49,	8,	34,	4,	'Your comments here'),
(42,	20,	97,	'2020-11-18',	3,	56,	8,	123,	123,	'Your comments here'),
(43,	20,	98,	'2020-11-11',	11,	79,	8,	54,	345,	'Your comments here'),
(44,	20,	99,	'2020-11-24',	12,	49,	8,	123,	123,	'Your comments here'),
(45,	20,	100,	'2020-11-22',	12,	71,	8,	543,	35,	'Your comments here'),
(46,	20,	101,	'2020-11-11',	5,	71,	10,	342,	564,	'Your comments here'),
(47,	20,	172,	'2020-11-15',	11,	90,	10,	342,	4,	'Your comments here'),
(48,	20,	171,	'2020-11-27',	3,	56,	8,	342,	123,	'Your comments here'),
(49,	20,	126,	'2020-11-18',	8,	79,	8,	123,	35,	'Your comments here'),
(50,	20,	130,	'2020-11-24',	12,	27,	8,	34,	345,	'Your comments here'),
(51,	20,	131,	'2020-11-11',	3,	79,	8,	54,	564,	'Your comments here'),
(52,	20,	93,	'2020-11-27',	3,	49,	8,	543,	4,	'Your comments here'),
(53,	20,	94,	'2020-11-25',	11,	56,	8,	123,	123,	'Your comments here'),
(54,	20,	95,	'2020-11-10',	8,	90,	8,	54,	123,	'Your comments here'),
(55,	20,	68,	'2020-11-19',	12,	90,	10,	342,	345,	'Your comments here'),
(56,	20,	69,	'2020-11-26',	3,	90,	8,	54,	35,	'Your comments here'),
(57,	20,	70,	'2020-11-12',	11,	90,	8,	543,	234,	'Your comments here'),
(58,	20,	73,	'2020-11-29',	5,	71,	8,	543,	564,	'Your comments here'),
(59,	20,	71,	'2020-11-26',	12,	79,	10,	54,	234,	'Your comments here'),
(60,	20,	55,	'2020-11-09',	11,	90,	8,	123,	35,	'Your comments here'),
(61,	20,	54,	'2020-11-11',	3,	90,	8,	342,	35,	'Your comments here'),
(62,	20,	53,	'2020-11-20',	12,	49,	8,	34,	123,	'Your comments here'),
(63,	20,	52,	'2020-11-25',	11,	90,	10,	123,	345,	'Your comments here'),
(64,	20,	47,	'2020-11-10',	3,	79,	8,	543,	564,	'Your comments here'),
(65,	20,	92,	'2020-11-23',	8,	56,	8,	342,	35,	'Your comments here'),
(66,	20,	91,	'2020-11-20',	11,	71,	8,	342,	35,	'Your comments here'),
(67,	20,	89,	'2020-11-25',	12,	90,	8,	123,	123,	'Your comments here'),
(68,	20,	121,	'2020-12-01',	3,	30,	8,	123,	123,	'Test Comment'),
(70,	20,	115,	'2020-12-01',	12,	79,	8,	123,	123,	'Your comments here');
